<template>
  <div class="drag" ref="dragDiv">
    <div class="drag_bg" :style="{ width: scrollLeft + 'px' }"></div>
    <div class="drag_text" :class="confirmSuccess ? 'drag_text_success' : ''">{{ confirmWords }}</div>
    <div
      ref="moveDiv"
...
export default {
  ...
  mounted() {
    ...
    console.log(this.$refs.dragDiv.clientWidth, this.$refs.moveDiv.clientWidth)
